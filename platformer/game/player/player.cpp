...
namespace herbglitch {
    Player::Player(ge::Data *data): ge::platformer::Entity(data){
        entity.setTexture(data->texture.getResource("cat idle")[0]);
        entity.setTexture(data->texture.getResource("cat idle")[0]);
    ...
    void Player::update(){
        ...
        if(entity.isFrame(data->texture.getResource("cat idle").getSize())){
            entity.setTexture(data->texture.getResource("cat idle")[entity.frame]);
        }
